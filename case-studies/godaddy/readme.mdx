...
GoDaddy has partnered with ENS (Ethereum NameService) to make DNS domains like **.com, .org, .ai,** and **.xyz** function as crypto wallet addresses.
...
This means theENS resolver can read offchain DNSSEC proofs at lookup time and without requiring a gas fee.
