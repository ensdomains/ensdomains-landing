...
<div className='not-prose space-y-4 pl-2'>
  <div className='flex items-center gap-2'>
    <img src="https://ens.domains/assets/brand/logo/ens-logo-Blue.svg" alt="ENS Logo" className='h-8' />
    <span>Main Icon</span>
  </div>

  <div className='flex items-center gap-2'>
    <img src="https://ens.domains/assets/brand/token-icon.svg" alt="Token Icon" className='h-12' />
...
export default function MDXPage({ children }) {
  return (
    <LegalLayout title="Trademark Guidelines" lastModified="17/09/2025">
      {children}
    </LegalLayout>
  )
}