...
export const BlogPostPreview = async ({ post, highlighted = false }: { post: BlogPostMetadataPlus, highlighted?: boolean }) => {
  ...
  return (
    <Link
      ...
      className={clsx(styles['preview-link'], highlighted && styles['preview-link-highlighted'])}
    >
      ...
      <div className={clsx(styles['preview-content-container'], highlighted && styles['preview-content-container-highlighted'])}>
