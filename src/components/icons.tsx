...
export const EnsNavIcon = (props: Props) => (
  <svg width="36" height="41" viewBox="0 0 36 41" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g>
      <path d="M17.0679 0.872362L6.02054 19.05C5.9339 19.1925 5.73261 19.2084 5.62514 19.0808C4.65258 17.926 1.02927 13.0132 5.51274 8.53546C9.60393 4.44952 14.815 1.53633 16.7462 0.529473C16.9653 0.41524 17.1961 0.66136 17.0679 0.872362Z" fill="currentColor" />
      <path d="M16.4569 40.4508C16.6774 40.6052 16.949 40.342 16.8013 40.1172C14.3337 36.3641 6.13115 23.8765 4.99806 22.002C3.88045 20.153 1.6823 17.0802 1.49892 14.4513C1.48062 14.1889 1.11771 14.1356 1.02642 14.3824C0.879189 14.7804 0.722441 15.2555 0.576352 15.7982C-1.26789 22.6492 1.41052 29.919 7.22746 33.9906L16.4569 40.4509V40.4508Z" fill="currentColor" />
      <path d="M17.9743 40.1276L29.0217 21.95C29.1083 21.8075 29.3096 21.7916 29.4171 21.9192C30.3896 23.0739 34.0129 27.9867 29.5295 32.4645C25.4383 36.5504 20.2273 39.4636 18.296 40.4705C18.0769 40.5847 17.8461 40.3386 17.9743 40.1276Z" fill="currentColor" />
