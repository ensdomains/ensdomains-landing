...
export default function AboutJobs() {
  return (
    <AboutJobsContainer id="about-ens">
      ...
      <p className="prelede">
        We’re always looking for talented people to expand the team. Please email your CV and cover letter to <a href="mailto:jobs@ens.domains">jobs@ens.domains</a>.
      </p>
      <p className="prelede">
